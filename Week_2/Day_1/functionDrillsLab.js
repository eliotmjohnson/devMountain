...
// let compareNums = (one, two) => {
//   if(one > two){
//     console.log(String(one))
//   } else if(two > one){
//     console.log(String(two))
//   } else console.log('Numbers are the same')
// }
...
let nameGreeting = nameCheck('Eliot')
...
let bestMovie = param => `${param} is the best movie ever!`
...
function aFunction(string){
  stringUpperCase = sampleString.toUpperCase()
  console.log(stringUpperCase)
}
// aFunction("Hi, my name is Kylo.")
...
// console.log(emailCheck('    WESFRTQEW RGFETRHYV%$%T$V%hrhr ##$&@#$% '))
...
function appropriate(gold){
  let totalFrogs = Math.floor(gold / 3) * 1
  return totalFrogs
}

let totalFrogs = appropriate(4)
