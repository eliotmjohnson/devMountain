...
// const func = function findGrape (arr) {
//     for(let i=0; i<arr.length; i++) {
//         if(arr[i].color === "purple") {
//             return console.log(`The fruit with index ${arr.indexOf(arr[i])} is a grape`)
//         } 
...
const oneLiner = (param1, param2) => console.log(`The first parameter is ${param1}. The second parameter is ${param2}`)
...
// greeting('Eliot', 'Johnson', ((fullName) => console.log(`Hello, my full name is ${fullName}`)))
