...
// ANSWER: No, it is already at a constant because it stops at 4 loops each time
...
const newFunc = (numbers) => {
	let newNumbers = numbers.map((e) => {
		return e * e;
	});
	return newNumbers;
};
...
// ANSWER: by looking at the output and what is hapving to be stored in the ram per each run of the code
